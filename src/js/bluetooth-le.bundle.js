var BLE = (() => {
  ...
  __export(index_exports, {
    ...
    ScanMode: () => ScanMode,
    dataViewToHexString: () => dataViewToHexString,
    dataViewToNumbers: () => dataViewToNumbers,
    dataViewToText: () => dataViewToText,
    hexStringToDataView: () => hexStringToDataView,
    mapToObject: () => mapToObject,
    numberToUUID: () => numberToUUID,
    numbersToDataView: () => numbersToDataView,
    textToDataView: () => textToDataView,
    toArrayBufferDataView: () => toArrayBufferDataView,
    toHexString: () => toHexString,
    toUint8Array: () => toUint8Array,
    webUUIDToString: () => webUUIDToString
  });
